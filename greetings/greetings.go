...
// Go executes init functions automatically at program startup, after global variables have been
// initialized.
func init() {
...
// lowercased functions are accessible only to code in its their package
// (in other words, they are not exported).
